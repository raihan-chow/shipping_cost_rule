...
<div class="login-box-body">
    <p class="login-box-msg">Verify Account
        @include('auth.flash_message')</p>

    <form action="{{url('/verify_account/' . $reference_id)}}" method="post">
        @csrf
        ...
        <div class="row">
            <div class="col-xs-4">
                <a href="{{url('/resend_otp_verify_account/' . $reference_id)}}" class="btn btn-primary btn-block btn-flat">Re-send</a>
            </div>
            <div class="col-xs-4">
            </div>
            <!-- /.col -->
