  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{asset('view_template/dist/css/skins/_all-skins.min.css')}}">

  <link rel="stylesheet" href="{{asset('view_template/dist/css/custom.min.css')}}">
  <style>
      .navbar-nav>.user-menu>.dropdown-menu {
    width: 200px;
}
  </style>
  @yield('header_stylesheet_extra')
